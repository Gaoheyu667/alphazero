...
numMCTSSims = 50
n1 = NNetWrapper(g)
n1.load_checkpoint(os.path.join('./', 'pretrained_models', 'dotsandboxes', 'keras', '3x3'), 'best.weights.h5')
args1 = dotdict({'numMCTSSims': numMCTSSims, 'cpuct': 1.0})
mcts1 = MCTS(g, n1, args1)
n1p = lambda x: np.argmax(mcts1.getActionProb(x, temp=0))

#n2 = NNetWrapper(g)
#n2.load_checkpoint(os.path.join('./', 'pretrained_models', 'dotsandboxes', 'keras', '3x3'), 'best.weights.h5')
